...
namespace Gorkem_.Migrations
{
    ...
    [Migration("20241206074547_HaftalikDegerlendirmeRaporuGuncellendi")]
    partial class HaftalikDegerlendirmeRaporuGuncellendi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.KT_KursKopekDegerlendirmeSorular", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KT_KursKopekDegerlendirmeSorular");
                });

            modelBuilder.Entity("Gorkem_.Context.Entities.KT_KursKursiyerDegerlendirmeSorular", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KT_KursKursiyerDegerlendirmeSorular");
                });
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_HaftalıkDegerlendirmeRaporuGozlemler", b =>
                {
                    ...
                    b.Property<int>("HaftalikDegerlendirmeRaporuId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HaftalikDegerlendirmeRaporuId");
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_KursHaftalıkDegerlendirmeRaporu", b =>
                {
                    ...
                    b.ToTable("UT_KursHaftalıkDegerlendirmeRaporus");
                });

            modelBuilder.Entity("Gorkem_.Context.Entities.UT_KursKopekDegerlendirmeCevap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("KopekDegerlendirmeSoruId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_KursKursiyerDegerlendirmeCevap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("KursiyerDegerlendirmeSoruId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_HaftalıkDegerlendirmeRaporuGozlemler", b =>
                {
                    b.HasOne("Gorkem_.Context.Entities.UT_KursHaftalıkDegerlendirmeRaporu", "HaftalikDegerlendirmeRaporu")
                        .WithMany("Gozlemler")
                        .HasForeignKey("HaftalikDegerlendirmeRaporuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("HaftalikDegerlendirmeRaporu");
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_KursKopekDegerlendirmeCevap", b =>
                {
                    b.HasOne("Gorkem_.Context.Entities.KT_KursKopekDegerlendirmeSorular", "KopekDegerlendirmeSoru")
                        .WithMany()
                        .HasForeignKey("KopekDegerlendirmeSoruId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Gorkem_.Context.Entities.UT_KursKursiyerDegerlendirmeCevap", b =>
                {
                    b.HasOne("Gorkem_.Context.Entities.KT_KursKursiyerDegerlendirmeSorular", "KursiyerDegerlendirmeSoru")
                        .WithMany()
                        .HasForeignKey("KursiyerDegerlendirmeSoruId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("KursiyerDegerlendirmeSoru");
                });
