...
namespace Gorkem_.Features.KodTablo
{
    public static class DeleteYabanciDil
    {
        ...
        internal sealed class Handler : IRequestHandler<Command, Result<bool>>
        {
            ...
            {
                var currentYabanciDil = await _context.KT_YabanciDils.FirstOrDefaultAsync(r => r.Id == request.Id && r.Aktifmi);
    ...
    public class DeleteYabanciDilEndpoint : ICarterModule
    {
        ...
        {
            app.MapDelete("kodtablo/yabancidil", async ([FromBody] YabanciDilSilRequest model, ISender sender) =>
            {
